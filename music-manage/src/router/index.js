...
const routes = [
  ...
  { path: '/login', name: 'Login', meta:{ name: '登录' }, component: () => import('../views/Login.vue')},
  {
    ...
    children:[
      ...
      { path: 'collect', name: 'Collect', meta:{ name: '收藏管理' }, component: () => import('../views/manager/Collect.vue')},
...
router.beforeEach((to , from, next) => {
  ...
  // from 是来源的路由信息
  // next 是帮助我们跳转路由的函数
  let adminPaths = ['/home','/consumer','/singer','/song','/songList','/listSong','/person','/password','/']
