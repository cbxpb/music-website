...
public class FileController {
    ...
    public Result upload(MultipartFile file,Integer type) throws IOException {
        ...
        url.setUploadUrl(newFilename);      //相对地址
    ...
    public Result dowmload(@PathVariable String fileName, HttpServletResponse response) throws IOException {
        ...
        if (flog == 1) {
            ...
            // 下载的请求头设置response.addHeader("Content-Disposition","attachment;fileName="+URLEncoder.encode(name[1],"UTF-8"));
            //  response.addHeader("Content-Disposition","attachment;fileName="+URLEncoder.encode(name[1],"UTF-8"));
